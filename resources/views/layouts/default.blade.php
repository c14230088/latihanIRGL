...
<div class="isi flex-1 flex flex-col justify-center items-center text-center">
@yield('isiPage')
</div>
...
<footer
  ...
  <div class="w-full bg-black/5 p-4 text-center">
    Latihan
    <a href="https://irgl.petra.ac.id/" class="footLink hover:text-violet-400 hover:decoration-solid">IRGL 2024</a>
  </div>
</footer>
